...
export default function EstudianteLayout() {
  return (
    <div className="ly">
      <aside className="sb">
        <h2 className="sb-title">Estudiante</h2>
        <nav className="sb-nav">
          <SidebarLink to="/estudiante">Dashboard</SidebarLink>
          <SidebarLink to="/estudiante/tareas">Tareas</SidebarLink>
          <SidebarLink to="/estudiante/simulacion">Simulación</SidebarLink>
        </nav>
      </aside>
